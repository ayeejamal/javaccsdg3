...
const Services = () => {
    ...
    const boxContents = [
        ...
        { title: "Edit & Delete Products", imageUrl: "url-to-image2.jpg", description: "You can edit product price and descriptions or delete the product itself", link: "/select-product" },
